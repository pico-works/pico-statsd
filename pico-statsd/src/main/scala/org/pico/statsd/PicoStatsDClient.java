...
public final class PicoStatsDClient implements StatsDClient {
     ...
     */
    public PicoStatsDClient(final String prefix, final String hostname, final int port) throws StatsDClientException {
     ...
     *     if the client could not be started
     */
    public PicoStatsDClient(final String prefix, final String hostname, final int port, final int queueSize) throws StatsDClientException {
     ...
     *     if the client could not be started
     */
    public PicoStatsDClient(final String prefix, final String hostname, final int port, final String... constantTags) throws StatsDClientException {
     ...
     *     if the client could not be started
     */
    public PicoStatsDClient(final String prefix, final String hostname, final int port, final int queueSize, final String... constantTags) throws StatsDClientException {
